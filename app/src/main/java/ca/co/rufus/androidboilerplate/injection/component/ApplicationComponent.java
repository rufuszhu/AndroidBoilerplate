...
import ca.co.rufus.androidboilerplate.injection.DebugUiModule;
...
@Singleton
@Component(modules = {ApplicationModule.class, DefaultSchedulersModule.class, DebugUiModule.class})
